...
export const HELP: Record<string, { label: string; short: string }> = {
  ...
  stopAdr: { label: "stop", short: "El stop de seguimiento (máximo de 22 ruedas menos 3 ATR), no el de una compra nueva: el plan en dólares no compra estos ADR, así que no hay orden que proteger. Los que están en el ranking de acciones (PAM) muestran el de ese ranking. El % se mide desde el techo de la franja." },
    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ol>
          ...
          <li><b>Entre las candidatas, el plan elige por convicción</b>. De la verificación web y de la revisión antes de comprar solo frenan un "evitar" y una objeción con fuente; "con reservas", "pendiente" o "no pude verificar" van escritos con ⚠ en la línea y decidís vos (desde el 18/9). Lo que compra dice COMPRAR, con su monto. El resto sigue como CANDIDATA con su motivo.</li>
