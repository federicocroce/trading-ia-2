...
describe("paridad ContributionPlan <-> contribution_plans", () => {
  it("todo campo del plan tiene su columna", () => {
    const plan: Required<ContributionPlan> = { month: "2026-09", totalUsd: 0, lines: [], notes: [], leftOut: [], tranches: 1, builtAt: "2026-09-13T00:00:00.000Z", inputs: {}, changes: [], previousBuiltAt: null, controles: null, reviewsPending: [], verificationsPending: [] };
