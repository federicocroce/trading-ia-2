...
export interface ContributionPlan { month: string; totalUsd: number; lines: PlanLine[]; notes: string[]; leftOut?: Array<{ symbol: string; reason: string }>; builtAt?: string; controles?: PlanControles | null; changes?: PlanChange[]; previousBuiltAt?: string | null; /** Lo que el plan compraría y espera la revisión antes de comprar (15/9). */ reviewsPending?: string[] }
