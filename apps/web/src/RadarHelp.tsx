    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ol>
          ...
          <li><b>Entre las candidatas, el plan elige por convicción</b>. De la IA solo frena un "evitar" de la verificación web; "con reservas", "pendiente", "no pude verificar" y las objeciones de la revisión antes de comprar van escritos con ⚠ en la línea y decidís vos (desde el 18/9). Lo que compra dice COMPRAR, con su monto. El resto sigue como CANDIDATA con su motivo.</li>
