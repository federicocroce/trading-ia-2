...
const EMPTY_RISK: RiskReport = { totalValue: 0, weights: [], concentration: { byCountry: {}, byIndustry: {}, hhiCountry: 0, hhiIndustry: 0, warnings: [] }, correlatedPairs: [], betas: {}, portfolioBeta: null, stressSpyMinus20Pct: null, liquidity: [], notes: [] };
